...
const _routes = [
  {
    ...
    children: [
      ...
      },
      {
        name: "tv",
        path: "",
        component: () => import('./index-CrDYvfWo.mjs')
      }
    ]
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BQhLtRNF.mjs')
  },
  {
    name: "movies",
    path: "/movies",
    component: () => import('./movies-C5I8nYmx.mjs')
  },
  {
    name: "search",
    path: "/search",
    component: () => import('./search-C4FIwsvW.mjs')
  },
  {
    name: "my-list",
    path: "/my-list",
    component: () => import('./my-list-fcrC5nDR.mjs')
  },
  {
    name: "movie-id",
    path: "/movie/:id()",
  ...
  },
  {
    ...
    component: () => import('./_id_--MUD3FPF.mjs'),
    children: [
      {
        name: "watch-tv-id-season-episode",
        path: ":season()/:episode()",
        meta: __nuxt_page_meta$2 || {},
        component: () => import('./_episode_-b9KoSda1.mjs')
      }
    ]
  },
  {
    ...
    component: () => import('./_id_-BCTIpTP-.mjs')
  }
];
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="w-9 h-9 rounded-xl bg-gradient-to-tr from-marxi-accent to-red-500 flex items-center justify-center shadow-glow-red group-hover:scale-105 transition-transform duration-300"${_scopeId}><span class="font-display font-black text-lg text-white tracking-tighter"${_scopeId}>RH</span></div><span class="font-display font-extrabold text-2xl tracking-tight text-white group-hover:text-red-400 transition-colors"${_scopeId}> RHFlix<span class="text-marxi-accent"${_scopeId}>.</span></span>`);
          } else {
            return [
              createVNode("div", { class: "w-9 h-9 rounded-xl bg-gradient-to-tr from-marxi-accent to-red-500 flex items-center justify-center shadow-glow-red group-hover:scale-105 transition-transform duration-300" }, [
                createVNode("span", { class: "font-display font-black text-lg text-white tracking-tighter" }, "RH")
              ]),
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_NuxtLink = __nuxt_component_0$1;
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "bg-marxi-950 border-t border-marxi-800/80 pt-12 pb-8 text-gray-400 text-sm" }, _attrs))}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"><div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8"><div class="md:col-span-2 space-y-4"><div class="flex items-center space-x-2"><div class="w-8 h-8 rounded-lg bg-gradient-to-tr from-marxi-accent to-red-500 flex items-center justify-center shadow-glow-red"><span class="font-display font-black text-sm text-white">RH</span></div><span class="font-display font-extrabold text-xl text-white"> RHFlix<span class="text-marxi-accent">.</span></span></div><p class="text-gray-400 max-w-sm text-xs leading-relaxed"> Stream your favorite movies, top-rated TV series, trending blockbusters, and exclusive releases online with fast, high-definition streaming on RHFlix. </p><div class="flex items-center space-x-3 text-xs text-gray-500"><span>Ultra HD Playback</span> • <span>Fast Streaming</span> • <span>Multi-Device</span></div></div><div><h4 class="text-white font-semibold text-xs tracking-wider uppercase mb-3">Quick Navigation</h4><ul class="space-y-2 text-xs"><li>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/",
