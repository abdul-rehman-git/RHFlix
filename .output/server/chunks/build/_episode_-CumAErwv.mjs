...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
      ...
      try {
        ...
        if (show.value) {
          ...
          addWatchHistory({
            ...
            backdropPath: ((_d = currentEpisode.value) == null ? void 0 : _d.still_path) || show.value.backdrop_path,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-3 sm:py-6 space-y-4 sm:space-y-6" }, _attrs))}><div class="flex flex-wrap items-center justify-between gap-3">`);
      ...
      _push(ssrRenderComponent(_component_PlaybackPlayer, {
        ...
        backdropPath: ((_c = unref(currentEpisode)) == null ? void 0 : _c.still_path) || ((_d = unref(show)) == null ? void 0 : _d.backdrop_path),
        episodeName: (_e = unref(currentEpisode)) == null ? void 0 : _e.name
      }, null, _parent));
      _push(`</div><div class="bg-marxi-850 rounded-2xl p-4 sm:p-6 border border-marxi-800 space-y-4 shadow-xl"><div class="flex flex-col md:flex-row md:items-center justify-between gap-3 border-b border-marxi-800 pb-4"><div><div class="flex items-center space-x-2 text-xs font-bold text-marxi-accent mb-1"><span>${ssrInterpolate(((_f = unref(show)) == null ? void 0 : _f.name) || "TV Series")}</span><span>\u2022</span><span>Season ${ssrInterpolate(unref(seasonNumber))}, Episode ${ssrInterpolate(unref(episodeNumber))}</span></div><h1 class="text-xl sm:text-3xl font-display font-black text-white">${ssrInterpolate(((_g = unref(currentEpisode)) == null ? void 0 : _g.name) || `Episode ${unref(episodeNumber)}`)}</h1></div><div class="flex items-center space-x-2"><select class="bg-marxi-800 border border-marxi-700 text-white text-xs font-semibold rounded-xl px-3 py-2 focus:outline-none focus:border-marxi-accent"><!--[-->`);
      ssrRenderList((_i = (_h = unref(show)) == null ? void 0 : _h.seasons) == null ? void 0 : _i.filter((s) => s.season_number > 0), (s) => {
      ...
      _push(`<!--]--></select></div></div><div class="space-y-1"><h3 class="text-white font-bold text-xs sm:text-sm">Episode Overview</h3><p class="text-gray-300 text-xs sm:text-sm leading-relaxed">${ssrInterpolate(((_j = unref(currentEpisode)) == null ? void 0 : _j.overview) || ((_k = unref(show)) == null ? void 0 : _k.overview) || "No episode description available.")}</p></div>`);
...
//# sourceMappingURL=_episode_-CumAErwv.mjs.map
