...
import { _ as _sfc_main$3 } from './ContentRow-w3FxNm5W.mjs';
...
import 'unhead/utils';
import 'vue-router';
import './ContentCard-tSabKuUV.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.item) {
        ...
        _push(`</div><h1 class="text-2xl sm:text-5xl lg:text-6xl font-display font-black text-white tracking-tight leading-tight sm:leading-none drop-shadow-md line-clamp-2">${ssrInterpolate(__props.item.title || __props.item.name)}</h1><p class="text-gray-300 text-xs sm:text-base line-clamp-2 sm:line-clamp-3 leading-relaxed max-w-xl drop-shadow">${ssrInterpolate(__props.item.overview || "Stream your favorite movies and series in full HD on Marxi.")}</p><div class="pt-2 sm:pt-3 flex flex-wrap items-center gap-3 sm:gap-4">`);
...
//# sourceMappingURL=index-DfniKajb.mjs.map
